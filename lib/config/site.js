...
export const SITE = {
  brand: {
    ...
    // Logo image, self-hosted in /public/brand (previously loaded from a temporary
    // third-party asset host — moved locally for reliability and performance).
    // Background is white in source; we use CSS mix-blend-multiply to make it
    // appear transparent on light backgrounds.
    logoUrl: '/brand/logo.jpg',
    social: {
      facebook: 'https://www.facebook.com/profile.php?id=61590781410330',
      instagram: 'https://www.instagram.com/bestefixo',
    },
  },
    contact: {
        phone: '+31 6 10 17 17 82',
    phoneRaw: '+31610171782',
    whatsappNumber: '31610171782',
    email: 'info@bestefixo.nl',
    kvk: '42083305',
    workArea: 'Noord-Holland, Zuid-Holland & Utrecht',
    ...
    seo: {
    title:
      'BesteFixo Schoonmaak | Professioneel Schoonmaakbedrijf in Noord-Holland, Zuid-Holland & Utrecht',
    description:
      'BesteFixo Schoonmaak — professionele schoonmaakdiensten voor bedrijven en particulieren. Kantoorschoonmaak, huisschoonmaak, fabrieken, scholen en meer. Vraag vrijblijvend een offerte aan.',
    keywords: [
      'schoonmaakbedrijf',
      'BesteFixo',
      'kantoorschoonmaak',
